...
const LoginSection = () => {
  ...
  // Eye icon SVGs for toggling password visibility
  const eyeIcon = (
    <svg
            ...
            <form onSubmit={formik.handleSubmit} className="font-vazir">
              <label className="form-control w-full max-w-xs">
                ...
                <input
                  ...
                  className="input focus:outline-primary border-none w-full max-w-xs bg-base-200 font-vazir"
              ...
              <label className="form-control w-full max-w-xs relative">
                ...
                <input
                  ...
                  className="input focus:outline-primary w-full max-w-xs bg-base-200 font-vazir"
              ...
              <p className="text-xs font-vazir text-gray-400 mt-2">
                هنوز ثبت نام نکردید؟
                <Link href="/register" className="text-primary px-2 font-vazir">
                  ثبت نام
                </Link>
              </p>
              ...
              <div className="flex justify-between items-center">
                <button
                  type="submit"
                  className="btn bg-primary border-none text-white !min-h-1 h-10 mt-2 disabled:bg-gray-400"
                  disabled={loading}
                >
                  {loading ? (
                ...
                <Link
                  href="/forgetpassword"
                  className="text-primary px-2 font-vazir text-xs"
                >
                  فراموش رمز
                </Link>
              </div>
